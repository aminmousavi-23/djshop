    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_integar', models.IntegerField(blank=True, null=True)),
                ...
                ('value_multi_option', models.ManyToManyField(related_name='multi_valued_attribute_value', to='catalog.optiongroupvalue')),
